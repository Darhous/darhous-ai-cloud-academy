...
const showcaseItems: ShowcaseItem[] = [
  ...
  },
  {
    id: "nano-banana",
    icon: "🍌",
    titleAr: "مختبر Nano Banana",
    titleEn: "Nano Banana Lab",
    descriptionAr: "اكتشف تريندات صور Gemini جاهزة وانسخ البرومبت لتحويل صورتك.",
    descriptionEn: "Explore Gemini Nano Banana image trends and copy prompts for your photos.",
    categoryAr: "Gemini Trends",
    categoryEn: "Gemini Trends",
    statusAr: "جديد 🔥",
    statusEn: "New 🔥",
    href: "/nano-banana-prompts",
    accent: "#f59e0b",
    gradFrom: "rgba(245,158,11,0.15)",
