...
export const portals: Portal[] = [
  ...
  },
  {
    ...
    descriptionAr: "60+ درس، 72 مشروع، 40+ تحدي أردوينو، ومكتبة المكونات الإلكترونية الشاملة.",
    descriptionEn: "60+ lessons, 72 projects, 40+ Arduino challenges, and comprehensive component library.",
    href: "/iot-lab",
    status: "available",
    icon: "🔌",
    color: "#f97316",
    ...
    category: "tech",
    features: ["60+ درس Arduino", "72 مشروع تطبيقي", "40+ تحدي برمجي", "مكتبة المكونات", "محاكي تفاعلي"],
    integrationType: "internal",
    ctaAr: "دخول المختبر",
    ctaEn: "Enter Lab",
    badgeAr: "جديد",
