...
export const portals: Portal[] = [
  {
    ...
    category: "ai",
    features: ["19 دورة", "62 أداة AI", "27 برومبت", "مرشد AI", "تحديات", "شهادات"],
  ...
  },
  {
    ...
    descriptionAr: "تعلم الأتمتة التجارية، استكشف 25 وصفة منتقاة، وابنِ workflows ذكية لأعمالك.",
    descriptionEn: "Learn business automation with 25 curated workflows, tools explorer, and workflow builder.",
    href: "/automation",
    status: "available",
    icon: "⚙️",
    color: "#4ade80",
    ...
    category: "tech",
    features: ["25 وصفة أتمتة", "مستكشف الأدوات", "مسارات التعلم", "خدمات احترافية", "معامل تطبيقية"],
    integrationType: "internal",
    ctaAr: "دخول البوابة",
    ctaEn: "Enter Portal",
    badgeAr: "جديد",
  ...
  },
  {
    ...
    descriptionAr: "60 درس، 73 مشروع، 41 تحدي أردوينو، ومكتبة المكونات الإلكترونية الشاملة.",
    descriptionEn: "60 lessons, 73 projects, 41 Arduino challenges, and comprehensive component library.",
    href: "/iot-lab",
    status: "available",
    icon: "🔌",
    color: "#f97316",
    ...
    category: "tech",
    features: ["60 درس Arduino", "73 مشروع تطبيقي", "41 تحدي برمجي", "مكتبة المكونات", "محاكي تفاعلي"],
    integrationType: "internal",
    ctaAr: "دخول المختبر",
    ctaEn: "Enter Lab",
    badgeAr: "جديد",
