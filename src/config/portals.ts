...
export const portals: Portal[] = [
  ...
  },
  {
    ...
    descriptionAr: "تعلم الأتمتة التجارية، استكشف 30+ قالب جاهز، وابنِ workflows ذكية لأعمالك.",
    descriptionEn: "Learn business automation with 30+ templates, tools explorer, and workflow builder.",
    href: "/automation",
    status: "available",
    icon: "⚙️",
    color: "#4ade80",
    ...
    category: "tech",
    features: ["30+ قالب أتمتة", "مستكشف الأدوات", "مسارات التعلم", "خدمات احترافية", "معامل تطبيقية"],
    integrationType: "internal",
    ctaAr: "دخول البوابة",
    ctaEn: "Enter Portal",
    badgeAr: "جديد",
