...
export const portals: Portal[] = [
  ...
  },
  {
    ...
    titleAr: "نانو بانانا",
    titleEn: "Nano Banana",
    descriptionAr: "مختبر برومبتات Gemini — اكتشف ستايلات تريندية وانسخ البرومبتات جاهزة لتحويل صورك.",
    descriptionEn: "Gemini Prompt Lab — discover trending image styles and copy ready-to-use prompts for your photos.",
  ...
  {
    id: "marketing",
    titleAr: "أكاديمية NexaLearn للتسويق",
    titleEn: "NexaLearn Marketing Academy",
    descriptionAr: "من الصفر إلى التسويق المدعوم بالذكاء الاصطناعي وأنظمة MCP — 16 مسارًا، إعلانات، فانلز، أتمتة، ووكلاء AI.",
    descriptionEn: "From zero to AI-powered marketing & MCP systems — 16 tracks: ads, funnels, automation, and AI agents.",
    href: "/marketing",
    status: "available",
    icon: "📈",
    color: "#ec4899",
    gradient: "linear-gradient(135deg, rgba(236,72,153,0.28) 0%, rgba(244,114,182,0.12) 100%)",
    category: "career",
    features: ["16 مسار تعلّم", "إعلانات Meta وGoogle وTikTok", "فانلز وأتمتة", "تسويق بالـ AI", "أنظمة MCP", "شهادات معتمدة"],
    featuresEn: ["16 Learning Tracks", "Meta · Google · TikTok Ads", "Funnels & Automation", "AI Marketing", "MCP Systems", "Certificates"],
    integrationType: "internal",
    ctaAr: "دخول البوابة",
    ctaEn: "Enter Portal",
    badgeAr: "جديد",
  ...
  },
  {
    ...
    descriptionAr: "مساحة مخصصة لإضافات NexaLearn المستقبلية: الأمن السيبراني، الروبوتات، الفريلانس، وأدوات الأعمال.",
    descriptionEn: "Space for future NexaLearn portals: cybersecurity, robotics, freelance, and business tools.",
    href: "/coming-soon",
    status: "coming-soon",
    icon: "🚀",
    color: "#c084fc",
