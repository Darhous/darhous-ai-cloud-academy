...
export const tools: Tool[] = [
  ...
  // Model Hubs & Gateways (C2 additions)
  { id: "huggingface",     name: "Hugging Face",      category: "AI Frameworks",    shortDescriptionAr: "أكبر مستودع لنماذج AI ومجموعات البيانات مفتوحة المصدر",    shortDescriptionEn: "The largest open-source hub for AI models, datasets and spaces", useCases: ["Models","Datasets","Spaces","Research"],  level: "intermediate", pricingType: "freemium",    bestFor: "Open models",    tags: ["huggingface","models","hub"],   featured: true  },
  { id: "openrouter",      name: "OpenRouter",         category: "AI Chatbots",      shortDescriptionAr: "بوابة موحدة للوصول لأكثر من 100 نموذج AI بـ API واحد",       shortDescriptionEn: "Unified gateway to 100+ AI models via a single API",           useCases: ["Multi-model","API","Cost","Comparison"],   level: "intermediate", pricingType: "freemium",    bestFor: "Model comparison",tags: ["openrouter","api","models"],   featured: false },
  { id: "google-ai-studio",name: "Google AI Studio",  category: "AI Chatbots",      shortDescriptionAr: "مساحة تجربة Gemini المجانية مع وصول مباشر للـ API والاختبار", shortDescriptionEn: "Free Gemini playground with direct API access and testing",     useCases: ["API Testing","Gemini","Prototyping"],      level: "beginner",     pricingType: "free",        bestFor: "Gemini API",     tags: ["google","gemini","studio"],    featured: false },
  { id: "flux-image",      name: "FLUX.1",             category: "Image Generation", shortDescriptionAr: "نموذج توليد صور مفتوح المصدر بجودة استثنائية من Black Forest Labs", shortDescriptionEn: "State-of-the-art open-source image generation by Black Forest Labs", useCases: ["Image Gen","Fine-tuning","Open-source"], level: "intermediate", pricingType: "open-source", bestFor: "Quality + open",  tags: ["flux","image","open-source"],  featured: false },
  { id: "warp",            name: "Warp Terminal",      category: "Coding Agents",    shortDescriptionAr: "طرفية برمجية مبنية لعصر AI مع إكمال ذكي ومشاركة الأوامر",     shortDescriptionEn: "AI-native terminal with smart completion and command sharing",  useCases: ["Terminal","AI Commands","Productivity"],   level: "beginner",     pricingType: "freemium",    bestFor: "AI terminal",    tags: ["warp","terminal","cli"],       featured: false },
  { id: "beautiful-ai",    name: "Beautiful.ai",       category: "Productivity AI",  shortDescriptionAr: "عروض تقديمية ذكية تتنسّق تلقائياً بمساعدة الذكاء الاصطناعي",   shortDescriptionEn: "Smart AI presentations that auto-format and adapt on their own", useCases: ["Presentations","Slides","Auto-design"],    level: "beginner",     pricingType: "freemium",    bestFor: "Auto-design slides", tags: ["beautiful","slides","design"],  featured: false },
];
