...
export const roadmaps: Roadmap[] = [
  ...
  {
    id: "how-to-write-prompt",
    titleAr: "ازاي تكتب برومبت",
    titleEn: "How to Write a Prompt",
    descriptionAr: "تعلّم فن صياغة البرومبت من الصفر حتى الاحتراف — من Zero-shot إلى وكلاء الذكاء الاصطناعي",
    descriptionEn: "Master prompt engineering from scratch to pro — from Zero-shot to AI agents",
    level: "beginner",
    totalWeeks: 6,
    outcome: "Write effective prompts for any AI model and use case",
    outcomeAr: "كتابة برومبتات فعّالة لأي نموذج AI وأي حالة استخدام",
    icon: "✍️",
    color: "cyan",
    nodes: [
      {
        id: "pr1",
        titleAr: "ما هو البرومبت؟",
        titleEn: "What is a Prompt?",
        descriptionAr: "تعريف البرومبت وكيف يتواصل الإنسان مع نماذج AI",
        descriptionEn: "Definition of a prompt and how humans communicate with AI models",
        duration: "3 days",
        skills: ["Prompt Basics", "AI Communication", "Input/Output"],
        status: "active",
      },
      {
        id: "pr2",
        titleAr: "Zero-shot Prompting",
        titleEn: "Zero-shot Prompting",
        descriptionAr: "طلب مهمة من النموذج مباشرة بلا أمثلة مسبقة",
        descriptionEn: "Ask the model to perform a task directly without prior examples",
        duration: "4 days",
        skills: ["Zero-shot", "Direct Instructions", "Clarity"],
        status: "upcoming",
        courseId: "prompt-engineering",
      },
      {
        id: "pr3",
        titleAr: "Few-shot Prompting",
        titleEn: "Few-shot Prompting",
        descriptionAr: "تقديم أمثلة قليلة للنموذج لتحسين الإخراج",
        descriptionEn: "Provide a few examples to the model to improve output quality",
        duration: "4 days",
        skills: ["Few-shot", "Examples", "In-context Learning"],
        status: "upcoming",
        courseId: "prompt-engineering",
      },
      {
        id: "pr4",
        titleAr: "Chain-of-Thought",
        titleEn: "Chain-of-Thought",
        descriptionAr: "إرشاد النموذج للتفكير خطوة بخطوة لحل المسائل المعقدة",
        descriptionEn: "Guide the model to think step-by-step for complex problem solving",
        duration: "4 days",
        skills: ["CoT", "Reasoning", "Step-by-step"],
        status: "upcoming",
        courseId: "prompt-engineering",
      },
      {
        id: "pr5",
        titleAr: "Role & Persona Prompting",
        titleEn: "Role & Persona Prompting",
        descriptionAr: "منح النموذج شخصية أو دوراً محدداً للحصول على إخراج متخصص",
        descriptionEn: "Give the model a specific role or persona for specialized output",
        duration: "3 days",
        skills: ["System Prompts", "Persona", "Role Play"],
        status: "upcoming",
        courseId: "claude-mastery",
      },
      {
        id: "pr6",
        titleAr: "Structured Output",
        titleEn: "Structured Output",
        descriptionAr: "طلب إخراج منظّم (JSON/Markdown/جدول) من النموذج",
        descriptionEn: "Request structured output (JSON/Markdown/table) from the model",
        duration: "3 days",
        skills: ["JSON Output", "Formatting", "Schema"],
        status: "upcoming",
        courseId: "prompt-engineering",
      },
      {
        id: "pr7",
        titleAr: "RAG-aware Prompting",
        titleEn: "RAG-aware Prompting",
        descriptionAr: "كتابة برومبتات تتعامل مع سياق مسترجع من قواعد المعرفة",
        descriptionEn: "Write prompts that work with context retrieved from knowledge bases",
        duration: "4 days",
        skills: ["RAG", "Context Injection", "Knowledge Bases"],
        status: "upcoming",
        courseId: "generative-ai",
      },
      {
        id: "pr8",
        titleAr: "Agent Prompting",
        titleEn: "Agent Prompting",
        descriptionAr: "تصميم برومبتات للوكلاء متعددي الخطوات والأدوات",
        descriptionEn: "Design prompts for multi-step agents with tool use",
        duration: "4 days",
        skills: ["Agents", "Tool Use", "Multi-step"],
        status: "upcoming",
        courseId: "claude-mastery",
      },
      {
        id: "pr9",
        titleAr: "التقييم والتحسين المستمر",
        titleEn: "Evaluation & Refinement",
        descriptionAr: "قياس جودة البرومبت وتحسينه بشكل منهجي",
        descriptionEn: "Measure prompt quality and improve it systematically",
        duration: "4 days",
        skills: ["Evaluation", "A/B Testing", "Iteration"],
        status: "upcoming",
      },
    ],
  },
